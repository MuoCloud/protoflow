        ...
        for (const field of Object.keys(fields)) {
            if (fields[field] !== 1) {
                if (field in refModels) {
                    ...
                    const reducedFields = exports.reduceFields(refModel, nextFields);
...
exports.dataFetcher = async (model, query, options) => {
    ...
    const rawQueryModifier = {
        ...
        project: (field, projection) => {
            Object.assign(exports.reduceFields, {
                [field]: projection
            });
        }
    };
