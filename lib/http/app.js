...
exports.useApp = async (config, lifecycle) => {
    ...
    app.register(microservice_loader_1.microServiceLoader, (_b = config.microService, (_b !== null && _b !== void 0 ? _b : { path: '/rpc' })));
    app.listen(config.port, (_c = config.address, (_c !== null && _c !== void 0 ? _c : '127.0.0.1')), () => {
