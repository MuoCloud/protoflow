    ...
    constructor(config) {
        ...
        this.populate = async (docs, options) => {
            ...
            if (refDocs.length > 0) {
                ...
                for (const doc of docs) {
                    const refIds = syntax_1.get(doc, path);
                    if (!refIds) {
                        continue;
                    }
                    if (Array.isArray(refIds)) {
                        syntax_1.set(doc, path, lodash_1.map(refIds, refId => { var _a; return _a = refDocMap.get(refId.toHexString()), (_a !== null && _a !== void 0 ? _a : refId); }));
                    }
                    else {
                        syntax_1.set(doc, path, (_a = refDocMap.get(refIds.toHexString()), (_a !== null && _a !== void 0 ? _a : refIds)));
                    }
                }
            }
        };
