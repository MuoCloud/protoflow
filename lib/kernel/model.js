            ...
            if (refDocs.length > 0) {
                ...
                for (const doc of docs) {
                    ...
                    if (Array.isArray(refIds)) {
                        syntax_1.set(doc, path, lodash_1.map(refIds, refId => { var _a; return (_a = refDocMap.get(refId.toHexString())) !== null && _a !== void 0 ? _a : refId; }));
                    }
                    else {
                        syntax_1.set(doc, path, (_a = refDocMap.get(refIds.toHexString())) !== null && _a !== void 0 ? _a : refIds);
                    }
                }
            }
        };
