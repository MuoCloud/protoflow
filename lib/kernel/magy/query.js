...
exports.resolveQuery = async (model, query, options = {}) => {
    ...
    const docs = await model
        ...
        ...(_a = options.customCommands) !== null && _a !== void 0 ? _a : [],
        ...query.sort ? [{
                $sort: query.sort
            }] : []
    ])
        .skip((_b = query.skip) !== null && _b !== void 0 ? _b : 0)
        .limit((query.limit &&
        query.limit < ((_c = options.maxLimit) !== null && _c !== void 0 ? _c : DEFAULT_MAX_LIMIT))
        ? query.limit
        : ((_d = options.maxLimit) !== null && _d !== void 0 ? _d : DEFAULT_MAX_LIMIT))
        .toArray();
    if (docs.length > 0) {
